...
function treeDropdown($compile){
    ...
    function getOptions(scope, data, level){
        ...
        angular.forEach(data, function(obj){
            ...
            var optionA = angular.element("<p ng-class='{selected:selected.id_category=="+obj.id_category+"}' class='level-"+level+"'>"+obj.name+"</p>");
            ...
            if(obj.subcategories){
                optionLI.append(getOptions(scope, obj.subcategories, level+1));
            }
